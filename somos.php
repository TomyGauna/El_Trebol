...
<body>
    ...
    <header class="d-flex flex-wrap align-items-center justify-content-between py-3 mb-4 border-bottom">
        ...
        <div id="botones" class="text-end">
            <ul id="sueltos" class="nav nav-pills">
                ...
                <li class="nav-item"><a href="somos.php" class="nav-link activo">Quiénes somos</a></li>
            </ul>
            <div class="container">
    ...
    <main class="cover-container d-flex w-75 sm-w-10 p-3 mx-auto flex-column">
        <div class="px-3">
            <div class="nota_fuerte">
                <div class="card border-0">
                    <span>
                        <h1>Somos el Trébol Diario </h1>
                        <h5>un medio de comunicación de la provincia de Buenos Aires.</h5>
                    </span>
                    <br>
                    <p class="lead">La agenda periodística está enfocada en los municipios de San Martín y la zona norte del conurbano bonaerense.
                        A través de nuestro sitio web y nuestras plataformas en redes sociales, nos esforzamos por llegar a un amplio espectro de sectores políticos, empresariales y sociales para conectar con potenciales lectores y clientes.
                        Creemos en la importancia de construir puentes informativos sólidos que unan a la comunidad, y es por eso que Trébol Diario se posiciona como un medio inclusivo, abierto a todas las voces y opiniones.
                        Te invitamos a seguirnos.</p>
                </div>
            </div>
        </div>
    </main>
