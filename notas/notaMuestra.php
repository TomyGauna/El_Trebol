...
<body>
            ...
            <div class="container">
                ...
                <div class="navbar-collapse d-lg-flex collapse" id="navbarsExample11">
                    <ul class="navbar-nav col-lg-6 justify-content-lg-center">
                        ...
                        <li class="nav-item"><a href="../somos.php" class="nav-link">Quienes somos?</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="nota_fuerte">
                <div class="card border-0">
                    <div class="d-flex justify-content-betwee">
                        <a class="text-dark" href="#"><?php echo $noticia['segment']; ?></a>
                        <p class="w-100"><?php echo $noticia['dia_creacion']; ?></p>
                    </div>
                    <h1><span><?php echo $noticia['titulo']; ?></span> <?php echo $noticia['contenido']; ?></h1>
                    <br>
                    <h2 class="card-title"><?php echo $noticia['contenido_2']; ?></h2>
                    <?php if ($noticia['imagen']): ?>
                        <img src="../img/<?php echo $noticia['imagen']; ?>" class="card-img-top img-principal" alt="<?php echo $noticia['titulo']; ?>">
                    <?php endif; ?>
                    
                    <?php echo $noticia['content_nuevo'];?>
                    <iframe src="https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Flocalhost%2Fel_trebol%2Fnotas%2FnotaMuestra.php%3Fid_noticia%3D68&layout&size&width=99&height=20&appId" width="99" height="20" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
    ...
    <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 border-top bg-secondary px-3 mb-0">
        ...
        <span class="mb-3 mb-md-0 text-body-secondary">© 2024 El Trebol Diario</span>
        </div>
