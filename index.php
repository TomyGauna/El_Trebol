...
$consulta_destacadas = "SELECT * FROM noticias ORDER BY is_field DESC";
$resultado_destacadas = $conexion->query($consulta_destacadas);

$consulta_publi = "SELECT * FROM publi";
$publis = $conexion->query($consulta_publi);

$main = "SELECT * FROM noticias WHERE segment='politica' AND priority_segment='primary' ORDER BY updated_at DESC LIMIT 1";
$resultMain = $conexion->query($main);

// Verificar si se obtuvieron resultados
if ($resultMain && $resultMain->num_rows > 0) {
    // Obtener la fila de resultados como un array asociativo
    $poliMain = $resultMain->fetch_assoc();
} else {
    // No se encontraron noticias que coincidan con los criterios
    $poliMain = null;
}

$sec = "SELECT * FROM noticias WHERE segment='politica' AND priority_segment='secondary' ORDER BY updated_at DESC LIMIT 2";
$resultSec = $conexion->query($sec);

// Verificar si se obtuvieron resultados
if ($resultSec && $resultSec->num_rows > 0) {
    // Obtener todas las filas de resultados como un array asociativo
    $poliSec = $resultSec->fetch_all(MYSQLI_ASSOC);
} else {
    // No se encontraron noticias que coincidan con los criterios
    $poliSec = array(); // Inicializar un array vacío en caso de que no haya resultados
}

$sec2 = "SELECT * FROM noticias WHERE segment='politica' AND priority_segment='none' ORDER BY updated_at DESC LIMIT 2";
$resultSec2 = $conexion->query($sec2);

// Verificar si se obtuvieron resultados
if ($resultSec2 && $resultSec2->num_rows > 0) {
    // Obtener todas las filas de resultados como un array asociativo
    $poliSec2 = $resultSec2->fetch_all(MYSQLI_ASSOC);
} else {
    // No se encontraron noticias que coincidan con los criterios
    $poliSec2 = array(); // Inicializar un array vacío en caso de que no haya resultados
}


// Consulta para obtener noticias por categoría (Ejemplo: Deportes, Tecnología, Entretenimiento, etc.)
// Deberías agregar más consultas según las categorías que desees mostrar en la página principal
...
<body>
    <header class="d-flex flex-wrap align-items-center justify-content-between py-3 mb-4 border-bottom">
        <ul id="redes" class="nav mb-2 justify-content-start mb-md-0">
            ...
            <!--</li>-->
            <li>
                <a href="https://www.instagram.com/treboldiario?igsh=MXY4amsyNHZyaW4ycQ==" class="nav-link px-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
            ...
            <li>
                <a href="https://x.com/treboldiario?t=MDkGSPk8Ea5dRRDQq_DErg&s=08" class="nav-link px-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
            ...
            <li>
                <a href="https://www.facebook.com/people/Tr%C3%A9bol-Diario/100092711918404/?mibextid=ZbWKwL" class="nav-link px-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
        ...
        <div id="botones" class="text-end">
            <ul id="sueltos" class="nav nav-pills">
                <li class="nav-item"><a href="index.php" class="nav-link activo" aria-current="page">Inicio</a>
                </li>
                <!--<li class="nav-item">-->
                <!--    <div class="dropdown">-->
                ...
                <li class="nav-item"><a href="somos.php" class="nav-link">Quiénes somos</a></li>
            </ul>
            <div class="container">
                    ...
                    <ul class="navbar-nav col-lg-6 justify-content-lg-center">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="dropdown-item"
                                        href="seccion.php?seccion=politica">Política</a>
                                </li>
                                <li>
                                    <a class="dropdown-item"
                                        href="seccion.php?seccion=sociedad">Sociedad</a>
                                </li>
                                <li>
                                    <a class="dropdown-item"
                                        href="seccion.php?seccion=cultura">Cultura</a>
                                </li>
                                <li>
                                    <a class="dropdown-item"
                                        href="seccion.php?seccion=deportes">Deportes</a>
                                </li>
                                <li>
                                    <a class="dropdown-item"
                                        href="seccion.php?seccion=unsam">UNSAM</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item"><a href="somos.php" class="nav-link">Quiénes somos</a></li>
    ...
    <main>
        <div class="in_container">
            ...
            <div class="portada">
                <!-- 1 -->
                <?php foreach ($resultado_destacadas as $noticias ): ?>
                    <?php if($noticias['is_field'] == 1): ?>
                        <div class="nota_principal">
                            <a href=" notas/nota.php?id_noticia=<?php echo $noticias['id']; ?> ">
                                <div class="card text-bg-dark">
                                    <img src="img/<?php echo $noticias['imagen']; ?>" class="card-img" alt="<?php echo $noticias['titulo']; ?>">
                                    <div class="card-img-overlay">
                                        <div>
                                            <h1><span><?php echo $noticias['titulo']; ?></span></h1>
                                        </div>
                                    </div>
                                </div>
                            </a>
            ...
            <!-- #endregion -->
            <!-- #region nota 4, 5 y 6 -->
            <div id="tres_notas_y_publi" class="hero">
                <!-- 4 y 5 -->
                <div class="dos_notas">
                    <?php foreach ($resultado_destacadas as $noticias ): ?>
                        <?php if($noticias['is_field'] == 4): ?>
                                <a href=" notas/nota.php?id_noticia=<?php echo $noticias['id']; ?> ">
                                    <div class="card border-1 border-black border-top-0 border-end-0 border-start-0 ">
                                        <img src="img/<?php echo $noticias['imagen']; ?>" class="card-img-top" alt="<?php echo $noticias['titulo']; ?>">
                                        <div class="card-body">
                                            <h5 class="card-title"><?php echo $noticias['titulo']; ?></h5>
                                            <p class="card-text"></p>
                ...
                <div class="publicidad">
                    <?php foreach ($publis as $publi ): ?>
                        <?php if($publi['is_field'] == 1): ?>
                            <a href="<?php echo $publi['link']; ?>">
                                <img src="img/<?php echo $publi['imagen']; ?>" alt="<?php echo $publi['titulo']; ?>">
                            </a>
                        <?php endif; ?>
                    <?php endforeach; ?>
                    <?php foreach ($publis as $publi ): ?>
                        <?php if($publi['is_field'] == 2): ?>
                            <a href="<?php echo $publi['link']; ?>">
                                <img src="img/<?php echo $publi['imagen']; ?>" alt="<?php echo $publi['titulo']; ?>">
                            </a>
                        <?php endif; ?>
            ...
            <!-- #region nota 7, 8 y 9 -->
            <div id="tres_notas" class="hero card border-1 border-black border-top-0 border-end-0 border-start-0">
                <?php foreach ($resultado_destacadas as $noticias ): ?>
                    <?php if($noticias['is_field'] == 7): ?>
                        <a href=" notas/nota.php?id_noticia=<?php echo $noticias['id']; ?> ">
                            <div class="card border-0 ">
                                <img src="img/<?php echo $noticias['imagen']; ?>" class="card-img-top" alt="<?php echo $noticias['titulo']; ?>">
                                <div class="card-body">
            ...
            <!-- #region publi 1, 2 y 3 -->
            <div id="tres_publi" class="hero">
                    <?php foreach ($publis as $publi ): ?>
                        <?php if($publi['is_field'] == 3): ?>
                            <a href="<?php echo $publi['link']; ?>">
                                <img src="img/<?php echo $publi['imagen']; ?>" alt="<?php echo $publi['titulo']; ?>">
                            </a>
                        <?php endif; ?>
            ...
            <!-- #region nota 10 y 11 -->
            <div id="dos_notas" class="hero">
                <!-- 10 -->
                <?php foreach ($resultado_destacadas as $noticias ): ?>
                    <?php if($noticias['is_field'] == 10): ?>
                        <div class="nota_fuerte">
                            <a href=" notas/nota.php?id_noticia=<?php echo $noticias['id']; ?> ">
                                <div class="card border-0">
                                    <img src="img/<?php echo $noticias['imagen']; ?>" class="card-img-top" alt="<?php echo $noticias['titulo']; ?>">
            ...
            <!-- #region nota 12, 13, 14 y 15 -->
            <div id="cuatro_notas" class="hero card border-1 border-black border-top-0 border-end-0 border-start-0">
                <!-- 12 -->
                <?php foreach ($resultado_destacadas as $noticias ): ?>
                    <?php if($noticias['is_field'] == 12): ?>
                        <a href=" notas/nota.php?id_noticia=<?php echo $noticias['id']; ?> ">
                            <div class="card border-0">
                                <img src="img/<?php echo $noticias['imagen']; ?>" class="card-img-top" alt="<?php echo $noticias['titulo']; ?>">
                                <div class="card-body">
            ...
            <!-- #region segmento Politica -->
            <div id="segmento" class="hero">
                <div class="seccion">
                    <svg class="ms-4" id="Capa_2" data-name="Capa 2" height="42" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 379.95 284.97">
                        <defs>
                            <style>
                                .cls-3 {
                                    fill: #7e7e7e;
                ...
                <div class="principal">
                    <div class="nota_fuerte">
                        <?php if($poliMain): ?>
                        <a href=" notas/nota.php?id_noticia=<?php echo $poliMain['id']; ?> ">
                            <div class="card border-0">
                                <img src="img/<?php echo $poliMain['imagen']; ?>" class="card-img-top" alt="<?php echo $poliMain['titulo']; ?>">
                                <div class="card-body">
                                    <h3 class="card-title">
                                        <span><?php echo $poliMain['titulo']; ?></span>
                                    </h3>
                                </div>
                            </div>
                        </a>
                ...
                <!-- <div id="cuatro_notas">
                    <?php foreach ($poliSec as $noticias ): ?>
                            <a href=" notas/nota.php?id_noticia=<?php echo $noticias['id']; ?> ">
                                <div class="card border-0 ">
                                    <img src="img/<?php echo $noticias['imagen']; ?>" class="card-img-top" alt="<?php echo $noticias['titulo']; ?>">
                                    <div class="card-body">
                    ...
                    <?php endforeach; ?>
                    <?php if($poliSec2): ?>
                        <?php foreach ($poliSec2 as $noticias ): ?>
                            <a href=" notas/nota.php?id_noticia=<?php echo $noticias['id']; ?> ">
                                <div class="card border-0 ">
                                    <img src="img/<?php echo $noticias['imagen']; ?>" class="card-img-top" alt="<?php echo $noticias['titulo']; ?>">
                                    <div class="card-body">
    ...
    <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 border-top bg-secondary px-3 mb-0">
        <div class="col-md-4 d-flex align-items-center">
        <a href="/" class="mb-3 me-2 mb-md-0 text-body-secondary text-decoration-none lh-1">
            <svg class="ms-1 ms-sm-2 ms-xl-4" id="Capa_2" data-name="Capa 2" height="24"
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 379.95 284.97">
                    <defs>
                        <style>
                            .cls-1 {
        ...
        <span class="mb-3 mb-md-0 text-body-secondary">© 2024 El Trébol Diario</span>
        </div>

        <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
            <li class="ms-3"><a class="text-body-secondary" href="https://www.instagram.com/treboldiario?igsh=MXY4amsyNHZyaW4ycQ=="><svg class="bi" width="24" height="24"><path d="M8 0C5.829 0 5.556.01 4.703.048 3.85.088 3.269.222 2.76.42a3.917 3.917 0 0 0-1.417.923A3.927 3.927 0 0 0 .42 2.76C.222 3.268.087 3.85.048 4.7.01 5.555 0 5.827 0 8.001c0 2.172.01 2.444.048 3.297.04.852.174 1.433.372 1.942.205.526.478.972.923 1.417.444.445.89.719 1.416.923.51.198 1.09.333 1.942.372C5.555 15.99 5.827 16 8 16s2.444-.01 3.298-.048c.851-.04 1.434-.174 1.943-.372a3.916 3.916 0 0 0 1.416-.923c.445-.445.718-.891.923-1.417.197-.509.332-1.09.372-1.942C15.99 10.445 16 10.173 16 8s-.01-2.445-.048-3.299c-.04-.851-.175-1.433-.372-1.941a3.926 3.926 0 0 0-.923-1.417A3.911 3.911 0 0 0 13.24.42c-.51-.198-1.092-.333-1.943-.372C10.443.01 10.172 0 7.998 0h.003zm-.717 1.442h.718c2.136 0 2.389.007 3.232.046.78.035 1.204.166 1.486.275.373.145.64.319.92.599.28.28.453.546.598.92.11.281.24.705.275 1.485.039.843.047 1.096.047 3.231s-.008 2.389-.047 3.232c-.035.78-.166 1.203-.275 1.485a2.47 2.47 0 0 1-.599.919c-.28.28-.546.453-.92.598-.28.11-.704.24-1.485.276-.843.038-1.096.047-3.232.047s-2.39-.009-3.233-.047c-.78-.036-1.203-.166-1.485-.276a2.478 2.478 0 0 1-.92-.598 2.48 2.48 0 0 1-.6-.92c-.109-.281-.24-.705-.275-1.485-.038-.843-.046-1.096-.046-3.233 0-2.136.008-2.388.046-3.231.036-.78.166-1.204.276-1.486.145-.373.319-.64.599-.92.28-.28.546-.453.92-.598.282-.11.705-.24 1.485-.276.738-.034 1.024-.044 2.515-.045v.002zm4.988 1.328a.96.96 0 1 0 0 1.92.96.96 0 0 0 0-1.92zm-4.27 1.122a4.109 4.109 0 1 0 0 8.217 4.109 4.109 0 0 0 0-8.217zm0 1.441a2.667 2.667 0 1 1 0 5.334 2.667 2.667 0 0 1 0-5.334z" /></svg></a></li>
        <li class="ms-3"><a class="text-body-secondary" href="https://x.com/treboldiario?t=MDkGSPk8Ea5dRRDQq_DErg&s=08"><svg class="bi" width="24" height="24"><path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865l8.875 11.633Z" /></svg></a></li>
        <li class="ms-3"><a class="text-body-secondary" href="https://www.facebook.com/people/Tr%C3%A9bol-Diario/100092711918404/?mibextid=ZbWKwL"><svg class="bi" width="24" height="24"><path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z" /></svg></a></li>
        </ul>
    </footer>
